      ...
      <div className="flex-cards" style={{ marginBottom: '2rem' }}>
        {cards.map((c, i) => (
          <div key={i} className="card">
            ...
            <h3 style={{ fontSize: '1.8rem', fontWeight: 700, color: c.color, margin: 0 }}>{c.value}</h3>
          </div>
        ))}
      </div>
...
const thStyle = { padding: '0.75rem', textAlign: 'left', borderBottom: '2px solid #eee', fontSize: '0.8rem', color: '#888', fontWeight: 600, textTransform: 'uppercase', whiteSpace: 'nowrap' };
const tdStyle = { padding: '0.75rem', borderBottom: '1px solid #f0f0f0', fontSize: '0.9rem', whiteSpace: 'nowrap' };
const statusStyle = (s) => ({
