...
const inputStyle = { display: 'block', padding: '0.5rem 0.8rem', border: '1px solid #ddd', borderRadius: 8, fontSize: '0.85rem', outline: 'none', boxSizing: 'border-box' };
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '1.5rem' }}>
          ...
          <tbody>
            <tr style={{ background: '#fafafa' }}>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem' }}>Basic Salary</td>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem', textAlign: 'right' }}>{slip.basicSalary?.toLocaleString() || '0'}</td>
            </tr>
            <tr>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem' }}>Allowances</td>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem', textAlign: 'right', color: '#2e7d32' }}>+{slip.allowances?.toLocaleString() || '0'}</td>
            </tr>
            <tr style={{ background: '#fafafa' }}>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem' }}>Deductions</td>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem', textAlign: 'right', color: '#c62828' }}>-{slip.deductions?.toLocaleString() || '0'}</td>
            </tr>
            <tr>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem' }}>Tax</td>
              <td style={{ padding: '0.6rem', fontSize: '0.85rem', textAlign: 'right', color: '#c62828' }}>-{slip.tax?.toLocaleString() || '0'}</td>
            </tr>
          </tbody>
          <tfoot>
      ...
      <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #eee', padding: '1.5rem', marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'end', flexWrap: 'wrap' }}>
          ...
          <div>
            ...
            <input type="number" value={form.year} onChange={(e) => setForm({ ...form, year: e.target.value })} style={{ ...inputStyle, width: 100 }} />
          </div>
          <button onClick={handleGenerate} style={btn}>Generate</button>
        </div>
      </div>
